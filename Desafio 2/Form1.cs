...
namespace ParcialGrafo
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            NodoOrigen.Posicion = new Point(167, 143);
            grafo.AgregarVertice(NodoOrigen);
            NodoOrigen.Valor = "Santa Ana";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(221, 192);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "San Andres";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(276, 217);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "San Salvador";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(121, 198);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Sonsonate";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(234, 231);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Santa Tecla";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(287, 125);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Colima";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(390, 238);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "San Vicente";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(70, 177);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Ataco";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(367, 280);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Zacatecoluca";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(347, 210);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Cojutepeque";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(382, 178);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Ilobasco";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(316, 158);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Suchitoto";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(272, 40);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "La Palma";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(220, 23);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Montecristo";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(481, 332);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Usulutan";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(468, 296);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Alegria";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(563, 278);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "San Miguel";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(568, 229);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Sn Franc. Gotera";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(556, 149);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "Perquin";

            NodoDestino = new CVertice();
            NodoDestino.Posicion = new Point(655, 335);
            grafo.AgregarVertice(NodoDestino);
            NodoDestino.Valor = "La Union";
        }
            ...
            switch (var_control)
            {
                ...
                case 2: //Crea nuevo nodo
                    if (nuevoNodo != null)
                    {
                        ...
                        //MessageBox.Show(posX.ToString() + " + " + posY.ToString());
        ...
        private void Pizarra_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Right)//si se presiona el boton derecho el mouse
            {
                if (var_control == 0)
                {
                    if ((NodoOrigen = grafo.DetectarPunto(e.Location)) != null)
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (txtBuscar.Text != "")
            {
                try
                {
                    grafo.ColorearNodo(txtBuscar.Text);
                    Refresh();
                    Thread.Sleep(1000);
        ...
        {
           // MessageBox.Show(a.Location.X.ToString());
        }
